...
No estado estacionário do Solow, o nível de capital por trabalhador $k^*$ e, portanto, o nível de renda por trabalhador $y^ = f(k^)$, depende da taxa de poupança $s$ (além de $n$, $g$ e $\delta$). Então países com maior $s$ têm maior $k^*$ e, logo, maior nível de renda per capita de longo prazo. Afirmação verdadeira.
